...
- [[#デモ][デモ]]
  ...
  - [[#サンプリング方法調査漁獲飼育に応じた振る舞いの変化][サンプリング方法（調査|漁獲|飼育）に応じた振る舞いの変化]]
    - [[#属性の取得][属性の取得]]
    - [[#ファイル名に属性を付与][ファイル名に属性を付与]]
    - [[#属性に応じてファイル名から情報を取得][属性に応じてファイル名から情報を取得]]
    - [[#データを読み込み][データを読み込み]]
- [[#開発環境の整備][開発環境の整備]]
  - [[#ディレクトリ作成][ディレクトリ作成]]
...
*** データを読み込み
#+BEGIN_SRC R :results value :exports both :session *R:tidyNAS*
...
#+RESULTS:
: commercial	20150827_Toyama_Nakase_001.hdr	nil	nil	nil	nil	001	7.606	7.606	0	nil	nil
: commercial	20150827_Toyama_Nakase_001.hdr	nil	nil	nil	nil	001	3.202	10.808	0	nil	nil
: commercial	20150827_Toyama_Nakase_001.hdr	nil	nil	nil	nil	001	2.102	12.91	0	nil	nil
: commercial	20150827_Toyama_Nakase_001.hdr	nil	nil	nil	nil	001	3.501	16.411	0	nil	nil
: commercial	20150827_Toyama_Nakase_001.hdr	nil	nil	nil	nil	001	2.302	18.713	0	nil	nil
: commercial	20150827_Toyama_Nakase_001.hdr	nil	nil	nil	nil	001	3.406	22.119	0	nil	nil
