...
#+end_example
* 追加予定の機能
[[https://github.com/smxshxishxad/tidyNAS/issues][Issues]] にて随時募集中
* 開発環境の整備
** ディレクトリ作成
...
#+begin_example
✔ | OK F W S | Context
⠏ |  0       | Control behavior according to dattype⠋ |  1       | Control behavior according to dattype⠙ |  2       | Control behavior according to dattype⠹ |  3       | Control behavior according to dattype⠸ |  4       | Control behavior according to dattype⠼ |  5       | Control behavior according to dattype⠴ |  6       | Control behavior according to dattype⠦ |  7       | Control behavior according to dattype⠧ |  7 1     | Control behavior according to dattype⠇ |  8 1     | Control behavior according to dattype⠏ |  9 1     | Control behavior according to dattype⠋ | 10 1     | Control behavior according to dattype⠙ | 11 1     | Control behavior according to dattype⠹ | 12 1     | Control behavior according to dattype⠸ | 12 2     | Control behavior according to dattype⠼ | 13 2     | Control behavior according to dattype⠴ | 14 2     | Control behavior according to dattype⠦ | 15 2     | Control behavior according to dattype⠧ | 16 2     | Control behavior according to dattype⠇ | 17 2     | Control behavior according to dattype⠏ | 17 3     | Control behavior according to dattype⠋ | 18 3     | Control behavior according to dattype⠙ | 19 3     | Control behavior according to dattype⠹ | 20 3     | Control behavior according to dattype⠸ | 21 3     | Control behavior according to dattype✖ | 21 3     | Control behavior according to dattype
────────────────────────────────────────────────────────────────────────────────
test_dattype.R:18: failure: get_info.survey() makes sample metadata correctly
info$sampleno not equal to "10".
Types not compatible: integer is not character

test_dattype.R:29: failure: get_info.commercial() makes sample metadata correctly
info$sampleno not equal to "005".
Types not compatible: integer is not character

test_dattype.R:40: failure: get_info.reared() makes sample metadata correctly
info$sampleno not equal to "01".
Types not compatible: integer is not character
────────────────────────────────────────────────────────────────────────────────
