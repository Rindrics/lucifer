...
#+BEGIN_SRC R
  ...
  fname <- "../data.git/漁海況/2018年3月/各県資料/熊本県/04 【熊本県】H29まき網＆棒受網 体長組成.xlsx"
  fmtbl.kagoshima <- function(fname) {
    alldata   <- readxl::read_excel(fname, sheet = "カタクチ", col_names = FALSE)
